...
\usepackage{minted}                % Usamos minted para el resaltado de sintaxis de los códigos.
	\usemintedstyle{monokai}        % Elegimos el perfil de "codeblocks".
...
\newminted{python}{
	...
	frame=single,
	framesep=1mm,                  % Setea la separación del frame a 2mm.
%	gobble=2,                      % Borra los 2 espacios adicionales agregados.
%	mathescape,                    % Permite insertar secuencias de escape matemáticas de LaTeX.
	rulecolor=\color{gray10p},     % color de la línea del recuadro.
	framerule=0.3mm,               % ancho de línea de recuadro
