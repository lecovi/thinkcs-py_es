...
\label{MY_COLORS}
\definecolor{gray65p}{rgb}{0.35,0.35,0.35}
\definecolor{gray45p}{rgb}{0.55,0.55,0.55}
\definecolor{gray15p}{rgb}{0.85,0.85,0.85}
\definecolor{gray10p}{rgb}{0.90,0.90,0.90}
\definecolor{gray05p}{rgb}{0.95,0.95,0.95}

\label{LISTINGS}
\usepackage{listings}                        % Permite mostrar código de forma mas linda
	\lstset{
		...
		deletekeywords={},                   % if you want to delete keywords from the given
		                                     % language
...
%		frameround=tttt,
		keepspaces=true,                     % keeps spaces in text, useful for keeping
		                                     ...
		                                     % columns=flexible)
		keywordstyle=\color[HTML]{F92672}\textbf,    % keyword style
