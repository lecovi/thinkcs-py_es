...
programa.
%\item La diferencia entre la función \texttt{input} y la función \texttt{raw\_input} es que
%la función input evalúa la cadena introducida y la función \texttt{raw\_input}
