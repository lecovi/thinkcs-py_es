...
%	    bookmarks=true,            % show bookmarks bar?
	    ...
	    pdftitle={\Title},         % 
	    %title
	    pdfauthor={Allen Downey, Jeffrey Elkner, Chris Meyers | Andrés Becerra Sandoval | \AutorNombreCompleto},  % author
...
\usepackage{listings}                        % Permite mostrar código de forma mas linda
	\lstset{
		...
		rulecolor=\color{black},             % if not set, the frame-color may be changed on
		                                     ...
		                                     % (green here))
		showspaces=false,                    % show spaces everywhere addingparticular
