...
%\usepackage[spanish]{babel} % Not needed, loaded language in lecv.tex
\usepackage{fancyhdr}
\usepackage{graphicx}
\usepackage{ucs}
\usepackage{hyperref}
...
\include{interludioTriqui}
\include{interludioFraccion}
\include{interludioTriquiGUI}
\clearemptydoublepage % creando un nuevo tipo de dato
\include{programasCompletos}
\clearemptydoublepage % programas completos
\include{lecturasRecomendadas}
